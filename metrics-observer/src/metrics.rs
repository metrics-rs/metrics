...
// These two Event types are distinct types. The first is the type generated by prost.
// It is the protobufs message, with decoding functions. The second is our metrics event.
use proto::Event as ProstMessage;
use proto::event::Event;
use proto::metric::Operation;
use proto::metadata::MetricType;
...
type MetadataStorage = Arc<RwLock<HashMap<MetadataKey, MetadataValue>>>;
pub struct Client {
